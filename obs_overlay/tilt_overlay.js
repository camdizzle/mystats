...
async function refresh() {
  try {
    ...
    const currentRunId = String(currentRun.run_id || '').trim();
    ...
    const lastRunId = String(payload.last_run?.run_id || '').trim();
    const runJustEnded = !!priorRunId && !currentRunId && lastRunId === priorRunId;
