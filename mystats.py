...
def _dashboard_dir_candidates():
    ...
    candidates = [
        ...
        os.path.join(install_dir, "modern_dashboard") if install_dir else '',
...
def reset(run_version_check=True):
    ...
    config.set_setting('tilt_total_xp_today', 0, persistent=True)
    config.set_setting('tilt_total_deaths_today', 0, persistent=True)
    config.set_setting('tilt_best_run_xp_today', 0, persistent=True)
    config.set_setting('tilt_highest_level_points_today', 0, persistent=True)
