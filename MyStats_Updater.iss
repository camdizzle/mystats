...
begin
  ...
  { Best-effort cleanup only. Do not block installer if PowerShell is restricted/unavailable. }
  Exec('powershell', '-NoProfile -ExecutionPolicy Bypass -Command "' + PsCommand + '"', '', SW_HIDE, ewNoWait, ResultCode);
end;
